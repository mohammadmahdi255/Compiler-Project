...
_lr_productions = [
  ...
  ('program -> PROGRAM_KW IDENTIFIER declarations procedure_list compound_statement DOT','program',6,'p_program','parser.py',37),
  ...
  ('declaration_list -> identifier_list COLON type','declaration_list',3,'p_declaration_list','parser.py',46),
  ('declaration_list -> declaration_list SEMICOLON identifier_list COLON type','declaration_list',5,'p_declaration_list','parser.py',47),
  ('identifier_list -> IDENTIFIER','identifier_list',1,'p_identifier_list','parser.py',51),
  ('identifier_list -> identifier_list COMMA IDENTIFIER','identifier_list',3,'p_identifier_list','parser.py',52),
  ('type -> INTEGER_KW','type',1,'p_type','parser.py',56),
  ('type -> REAL_KW','type',1,'p_type','parser.py',57),
  ('procedure_list -> procedure_list procedure','procedure_list',2,'p_procedure_list','parser.py',61),
  ('procedure_list -> procedure_list function','procedure_list',2,'p_procedure_list','parser.py',62),
  ('procedure_list -> empty','procedure_list',1,'p_procedure_list','parser.py',63),
  ('procedure -> PROCEDURE_KW IDENTIFIER parameters SEMICOLON declarations compound_statement SEMICOLON','procedure',7,'p_procedure','parser.py',67),
  ('function -> FUNCTION_KW IDENTIFIER parameters COLON type SEMICOLON declarations compound_statement SEMICOLON','function',9,'p_function','parser.py',71),
  ('parameters -> LRB declaration_list RRB','parameters',3,'p_parameters','parser.py',75),
  ('parameters -> empty','parameters',1,'p_parameters','parser.py',76),
  ('compound_statement -> BEGIN_KW statement_list END_KW','compound_statement',3,'p_compound_statement','parser.py',80),
  ('statement_list -> statement','statement_list',1,'p_statement_list','parser.py',86),
  ('statement_list -> statement_list SEMICOLON empty statement','statement_list',4,'p_statement_list','parser.py',87),
  ('statement -> IDENTIFIER ASSIGN expression','statement',3,'p_statement_assign','parser.py',91),
  ('statement -> IF_KW expression THEN_KW empty statement empty_N ELSE_KW empty statement','statement',9,'p_statement_if_else','parser.py',104),
  ('statement -> IF_KW expression THEN_KW empty statement empty_N','statement',6,'p_statement_if','parser.py',126),
  ('statement -> WHILE_KW empty expression DO_KW empty statement','statement',6,'p_statement_while','parser.py',143),
  ('statement -> compound_statement','statement',1,'p_statement_compound','parser.py',161),
  ('statement -> IDENTIFIER arguments','statement',2,'p_statement','parser.py',167),
  ('statement -> empty','statement',1,'p_statement','parser.py',168),
  ('arguments -> LRB actual_parameter_list RRB','arguments',3,'p_arguments','parser.py',172),
  ('actual_parameter_list -> actual_parameter_list COMMA actual_parameter','actual_parameter_list',3,'p_actual_parameter_list','parser.py',176),
  ('actual_parameter_list -> actual_parameter','actual_parameter_list',1,'p_actual_parameter_list','parser.py',177),
  ('actual_parameter -> expression','actual_parameter',1,'p_actual_parameter','parser.py',181),
  ('expression -> INTEGER_CONSTANT','expression',1,'p_expression_assign_constant','parser.py',185),
  ('expression -> REAL_CONSTANT','expression',1,'p_expression_assign_constant','parser.py',186),
  ('expression -> IDENTIFIER','expression',1,'p_expression_assign_identifier','parser.py',193),
  ('expression -> SUB expression','expression',2,'p_expression_uminus','parser.py',200),
  ('expression -> expression SUM expression','expression',3,'p_expression_op','parser.py',209),
  ('expression -> expression SUB expression','expression',3,'p_expression_op','parser.py',210),
  ('expression -> expression MUL expression','expression',3,'p_expression_op','parser.py',211),
  ('expression -> expression DIV expression','expression',3,'p_expression_op','parser.py',212),
  ('expression -> expression DIV_KW expression','expression',3,'p_expression_op','parser.py',213),
  ('expression -> expression MOD_KW expression','expression',3,'p_expression_op','parser.py',214),
  ('expression -> expression LT expression','expression',3,'p_expression_op','parser.py',215),
  ('expression -> expression LE expression','expression',3,'p_expression_op','parser.py',216),
  ('expression -> expression EQ expression','expression',3,'p_expression_op','parser.py',217),
  ('expression -> expression NE expression','expression',3,'p_expression_op','parser.py',218),
  ('expression -> expression GT expression','expression',3,'p_expression_op','parser.py',219),
  ('expression -> expression GE expression','expression',3,'p_expression_op','parser.py',220),
  ('expression -> expression AND_KW empty expression','expression',4,'p_expression_bool','parser.py',250),
  ('expression -> expression OR_KW empty expression','expression',4,'p_expression_bool','parser.py',251),
  ('expression -> NOT_KW expression','expression',2,'p_expression_not','parser.py',273),
  ('expression -> LRB expression RRB','expression',3,'p_expression','parser.py',286),
  ('empty -> <empty>','empty',0,'p_empty','parser.py',303),
  ('empty_N -> <empty>','empty_N',0,'p_empty_N','parser.py',308),
]
