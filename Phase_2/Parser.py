...
class Parser:
    ...
    def p_declaration_list(p):
        ...
        print("declaration_list : identifier_list COLON type | declaration_list SEMICOLON identifier_list COLON type")
    ...
    def p_procedure_list(p):
        """procedure_list : procedure_list procedure
                          ...
                          | empty"""
        print("""procedure_list : procedure_list procedure | procedure_list function | empty""")

    @staticmethod
    def p_procedure(p):
        """procedure : PROCEDURE_KW IDENTIFIER parameters SEMICOLON declarations compound_statement SEMICOLON"""
        print("procedure : PROCEDURE_KW IDENTIFIER parameters SEMICOLON declarations compound_statement SEMICOLON")

    @staticmethod
    def p_function(p):
        """function : FUNCTION_KW IDENTIFIER parameters COLON type SEMICOLON declarations compound_statement SEMICOLON"""
        print("function : FUNCTION_KW IDENTIFIER parameters COLON type SEMICOLON declarations compound_statement SEMICOLON")
    ...
    def p_statement(p):
        """statement : IDENTIFIER ASSIGN expression
                     ...
                     | empty"""
        print("""statement : IDENTIFIER ASSIGN expression | IF_KW expression THEN_KW statement ELSE_KW statement | IF_KW expression THEN_KW statement | WHILE_KW expression DO_KW statement | compound_statement | IDENTIFIER arguments | empty""")
